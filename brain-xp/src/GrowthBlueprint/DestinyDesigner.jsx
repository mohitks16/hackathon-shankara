...
export default function DestinyDesigner({ onBack }) {
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#111827] to-black text-white flex items-center justify-center px-6">
            <div className="w-full max-w-2xl text-center">
                ...
                >
                    ...
                    <h2 className="text-4xl font-extrabold bg-gradient-to-r from-purple-400 to-pink-500 text-transparent bg-clip-text mb-4">
                        Destiny Designer
                    </h2>
                    <p className="text-gray-400 text-lg mb-8">
                        Create a roadmap and get expert advice for your specific goal. (Feature Coming Soon)
                    </p>
